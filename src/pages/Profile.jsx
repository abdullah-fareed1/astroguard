...
const Profile = () => {
  ...
  const [astronautData] = useState({
    ...
    profileImage: null, // Set to URL string when available from backend, null shows default avatar
          ...
          <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
            ...
            <div className="bg-slate-800/40 backdrop-blur-xl rounded-3xl p-6 border border-slate-700/50 shadow-2xl">
              ...
              <div className="space-y-4">
                <div className="bg-slate-900/50 rounded-xl p-4">
                  ...
                  <p className="text-lg font-semibold text-cyan-400 pl-8">{astronautData.id}</p>
                  <p className="text-xs text-slate-500 pl-8 mt-1">Non-editable</p>
                </div>
                ...
                <div className="bg-slate-900/50 rounded-xl p-4">
                  ...
                  <p className="text-lg font-semibold text-white pl-8">{formatDate(astronautData.joinedDate)}</p>
                  <p className="text-xs text-slate-500 pl-8 mt-1">{getTimeSinceJoined(astronautData.joinedDate)} ago</p>
                </div>
              </div>
            </div>
            ...
            <div className="xl:col-span-2 bg-slate-800/40 backdrop-blur-xl rounded-3xl p-6 border border-slate-700/50 shadow-2xl">
              ...
              <div className="space-y-6">
                ...
                <div>
                  <h3 className="text-lg font-semibold mb-4 text-slate-300">Personal Information</h3>
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full bg-slate-900/50 border border-slate-700/50 rounded-xl pl-12 pr-4 py-3 text-white placeholder-slate-500 focus:outline-none focus:border-purple-500/50 focus:ring-2 focus:ring-purple-500/20 transition-all"
                ...
                {/* Security Section */}
                <div>
                  <h3 className="text-lg font-semibold mb-2 text-slate-300">Security</h3>
                  <p className="text-sm text-slate-400 mb-4">Leave password fields empty if you don't want to change your password</p>
                ...
                <div className="flex justify-end pt-4">
                  <button
                    type="submit"
                    disabled={isSaving}
                    className="px-8 py-3 bg-gradient-to-r from-purple-500 to-blue-500 hover:from-purple-600 hover:to-blue-600 rounded-xl font-semibold transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2 shadow-lg hover:shadow-purple-500/25"
                  >
                    {isSaving ? (
                      <>
